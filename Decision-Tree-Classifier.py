# -*- coding: utf-8 -*-
"""
Created on Thu Aug 16 17:40:19 2018
...
#Plot PREDICTED vs TRUE data - Test Data
...
plt.title(' Decision Tree Vlassifier( Test set)')
plt.xlabel('Age')
...
#Plot PREDICTED vs TRUE data - Training data
from matplotlib.colors import ListedColormap
